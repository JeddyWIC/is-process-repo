...
export default function RichEditor({ content, onChange }: RichEditorProps) {
  const editor = useEditor({
    ...
    extensions: [
      ...
      Placeholder.configure({
        placeholder: "Write your process documentation here... You can add headings, lists, images, and more.",
      }),
    ],
    content,
    onUpdate: ({ editor }) => {
  ...
  if (!editor) {
    return <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800 min-h-[300px]" />;
  }
